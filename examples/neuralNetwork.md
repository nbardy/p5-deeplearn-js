...
This is a demonstration of a neural network trained to recognize digits using the [MNIST database](http://yann.lecun.com/exdb/mnist/).

<iframe src="https://cvalenzuela.github.io/p5-deeplearn-js/examples/NeuralNetwork/" style="height:550px"></iframe>
