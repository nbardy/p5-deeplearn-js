---
title: "Example"
path: "/examples/word2vec"
name: "Word2Vec"
---

Word2vec

<iframe src="https://cvalenzuela.github.io/p5-deeplearn-js/examples/word2vec/" style="height:450px"></iframe>
...
function setup() {
  ...
  wordVectors = new p5ml.Word2Vec('data/wordvecs10000.json');
